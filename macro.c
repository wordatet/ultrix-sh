#ifndef lint
static char sccsid[] = "@(#)macro.c	4.2 (ULTRIX) 8/13/90";
 ...
 * ~~~~~~~~~~~~~~~~~~~~
 * 002	David Lindner Wed Jun  6 11:33:50 EDT 1990
 *	- Added second argument to await for background flag.
 *
 * 001	David Lindner Fri Sep 22 11:09:34 EDT 1989
 *	- Fixed premature unlinking of temporary files, that was causing
 *	  hereis document bug. Also added comment header.
 *
 */
...
LOCAL VOID	comsubst()
{
	...
	/*
	 * DJL 001 
	 * Commented out tdystak, becasuse tmp files were being
	 * ulinked prematurely.
	 * tdystak(savptr); 
	 */
